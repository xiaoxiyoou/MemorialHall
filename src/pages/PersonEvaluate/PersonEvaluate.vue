            ...
            <div class="context clear-fix">
              <div class="contextTop clear-fix">
                ...
                <div class="rightCon row a-c">
                  ...
                  <Star :grade="item.ResidentMsgScore" />
                </div>
              </div>
              <p class="contextBtm">
                {{item.ResidentMsgMain}}
              </p>
            </div>
        </li>
      </cube-scroll>
...
import { personEvaList } from  'api/index'
...
export default {
  ...
  mounted(){
    this._getCompanyEvaList(this.$route.query.id)
  },
  methods:{
    _getCompanyEvaList(id){
      personEvaList({
        id,
        PageSize: 10,
        PageIndex: 1
        ...
        console.log(res)
        if(res.code === 0){
          this.grade = Number(res.data.MsgAvage)
          this.evalist = res.data.MsgList
